param (
	...
	[switch]$ValidateOnly,
	[Parameter(HelpMessage="Ignores a higher version of SQL than SP1 which is verfied by Sitecore. Should be ok for the most part.")]
...
Write-Information "Loading SIF 1.2.1" 
